...
[진로 및 창의적 체험활동 참고안]
유치원교사(토리)를 진로 목표로 설정하고 매주 교과 연계 탐구 일지를 구조화하여 기록하고 실천함. 청소년 정서 상담을 위한 기획 아이디어를 프로토타입 설계서로 구현하는 등 타인을 배려하는 감수성과 주도적인 과제 탐구 역량을 균형 있게 발휘함.
...
[진로 및 창의적 체험활동 참고안]
로봇공학자로의 확고한 진로 목표를 지니고 과학 기술 고전 독서 및 윤리 토론에 적극 참여함. 기술 발전이 공동체에 미치는 영향을 논리적으로 개진하며 협업 시 실질적인 기여를 해내는 등 전도유망한 엔지니어로서의 성장 가능성을 드러냄.
...
[진로 및 창의적 체험활동 참고안]
소프트웨어개발자로의 진로를 정립하고 관련 프로그래밍 생태계를 주도적으로 탐색함. 스스로 심화 기술 문헌을 조사하며 프로젝트의 완성도를 높이려는 성실함과 지적 몰입도가 돋보임.
