          ...
          {assessments.map((item) => {
            ...
            return (
              <Card
                ...
                className={`flex flex-col justify-between border-2 transition-all group min-h-[300px] ${isCompleted
              ...
              >
                <div className="flex flex-col gap-3">
                  <div className="flex justify-between items-center">
                    <span className={`text-xs font-headline font-bold px-3 py-1 rounded-full ${item.category === "흥미무드" ? "bg-primary/10 text-primary" : item.category === "다중지능" ? "bg-secondary/15 text-secondary-spot" : "bg-surface-container text-text-primary"
                      }`}>
                      #{item.category}
                    </span>
