        ...
        <div className="space-y-6">
          <div className="w-full h-48 sm:h-60 rounded-2xl overflow-hidden shadow-inner bg-slate-900 relative group">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent flex items-end p-5">
              <span className="text-xs text-purple-200 font-bold tracking-wider uppercase bg-purple-900/80 px-3 py-1 rounded-full border border-purple-400/30">
                AI 진로 상황 시뮬레이션 #{currentIdx + 1}
              </span>
            </div>
          </div>
          ...
          <div className="space-y-3 pt-2">
            <button
              ...
              className="w-full p-4 sm:p-5 text-left rounded-2xl bg-slate-50 hover:bg-purple-50 hover:border-purple-300 border-2 border-slate-200 transition-all duration-200 shadow-sm flex items-center justify-between group"
            >
              <div className="flex items-center gap-3 sm:gap-4">
                <span className="w-9 h-9 rounded-xl bg-white border border-slate-200 font-black text-purple-700 flex items-center justify-center text-sm group-hover:bg-purple-600 group-hover:text-white transition-colors flex-shrink-0 shadow-sm">
                  A
                </span>
                <span className="text-xs sm:text-sm font-black text-slate-700 group-hover:text-purple-900 transition-colors leading-relaxed">
                  {currentQ.options.A.label}
                </span>
              </div>
              <span className="text-xs font-bold text-purple-600 bg-purple-100 px-2.5 py-1 rounded-full opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap hidden sm:inline-block">
                선택 &rarr;
              </span>
            </button>
