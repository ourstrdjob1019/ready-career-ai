...
const LIKERT_OPTIONS = [
  { value: 5, label: "이거 완전 내 얘기야!", bg: "bg-white", text: "text-gray-700", border: "border-gray-200", hover: "hover:border-gray-300 shadow-sm", point: "bg-gray-200" },
  { value: 1, label: "아직은 좀 어려워", bg: "bg-white", text: "text-gray-700", border: "border-gray-200", hover: "hover:border-gray-300 shadow-sm", point: "bg-gray-200" },
];
    ...
    return (
      <div className="min-h-screen bg-[#F5F5F5] flex items-center justify-center p-6">
        <div className="bg-white rounded-2xl p-10 max-w-sm w-full text-center shadow-sm border border-[#dddddd]">
          ...
          <h2 className="text-2xl font-semibold tracking-tighter text-black mb-3 tracking-tight">마인드셋<br/>지수 계산 중!</h2>
    ...
    return (
      <div className="min-h-screen bg-[#F5F5F5] pt-10 pb-20 px-5">
        <div className="max-w-md mx-auto space-y-6">
          <div className="bg-white rounded-2xl p-7 shadow-sm border border-emerald-200/60 text-center">
            <div className="inline-block px-3 py-1 bg-emerald-50 text-emerald-600 font-semibold tracking-tighter text-xs rounded-full mb-4">
              나의 성장 마인드셋 상태
            </div>
            ...
            <div className="flex items-end justify-center gap-2 mt-4">
              <div className="text-5xl font-semibold tracking-tighter text-emerald-600 leading-none">{overallAvg}</div>
              <div className="text-sm font-medium tracking-tight text-[#707070] pb-1">/ 100 · 마인드셋 지수</div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl p-7 shadow-sm border border-[#dddddd]">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="bg-white rounded-2xl border border-[#dddddd] p-4">
                ...
                <div className="text-xs font-semibold tracking-tighter text-emerald-800 mb-2">강점 · {strongDomain.name}</div>
          ...
          <div className="bg-white rounded-2xl p-7 shadow-sm border border-[#dddddd]">
            ...
            <div className="bg-white rounded-2xl p-5 border border-orange-200 shadow-sm">
              <div className="text-[10px] font-semibold tracking-tighter text-orange-600 mb-2">가장 먼저 바꿔볼 반응</div>
              <h4 className="text-base font-semibold tracking-tighter text-black mb-2">{lowTitle}</h4>
              <p className="text-xs text-gray-600 leading-relaxed">{lowDomain.change}</p>
            </div>
          </div>

          <div className="bg-emerald-600 rounded-2xl p-7 shadow-lg">
    ...
    <div className="min-h-screen bg-[#F5F5F5] flex flex-col">
      <header className="sticky top-0 z-20 bg-white/90 backdrop-blur-md border-b border-gray-200 px-5 py-4">
        <div className="max-w-md mx-auto flex items-center justify-between">
          <div className="text-base font-semibold tracking-tighter text-black tracking-tight">성장 마인드셋 프로파일</div>
      ...
      <main className="flex-1 max-w-md w-full mx-auto p-5 pb-32 flex flex-col justify-center">
        <div className="mb-8 relative flex flex-col items-center">
          <div className="w-full bg-white rounded-2xl p-6 pt-16 mt-12 border-t-4 border-gray-200 relative text-center shadow-sm">
            ...
            <span className="text-[11px] font-semibold tracking-tighter text-black bg-white px-3 py-1 rounded-full mb-3 inline-block">
              {typeInfo.name} 마인드셋
            </span>
            <p className="text-xl font-semibold tracking-tighter text-black leading-tight break-keep">"{currentQ.q}"</p>
          </div>
        </div>
