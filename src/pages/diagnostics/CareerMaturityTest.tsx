...
const LIKERT_OPTIONS = [
  { value: 5, label: "맞아요, 그 길로 가고 있어요", bg: "bg-white", text: "text-gray-700", border: "border-gray-200", hover: "hover:border-gray-300 shadow-sm", point: "bg-gray-200" },
  { value: 1, label: "아직은 그 위치가 아니에요", bg: "bg-white", text: "text-gray-700", border: "border-gray-200", hover: "hover:border-gray-300 shadow-sm", point: "bg-gray-200" },
];
