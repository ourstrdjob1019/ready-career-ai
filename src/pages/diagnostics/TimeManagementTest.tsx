            ...
            return (
              <button
                ...
                className={`w-full p-5 rounded-2xl border-2 font-semibold tracking-tighter text-[15px] sm:text-lg transition-all flex flex-col items-center justify-center gap-4 text-center shadow-sm hover:shadow-md ${
                  isSelected 
                    ? 'bg-blue-500 border-blue-600 text-white ring-2 ring-blue-400 ring-offset-2' 
                    : 'bg-white border-blue-200 text-slate-700 hover:border-blue-300 hover:bg-blue-50/50'
                }`}
              >
                <div className={`w-5 h-5 rounded-full flex-shrink-0 transition-all border-2 flex items-center justify-center ${isSelected ? 'bg-white border-white' : 'bg-transparent border-blue-300'}`}>
